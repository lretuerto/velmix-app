...
class RbacCatalogSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['code' => 'billing.provider.read', 'name' => 'Consultar proveedor de facturacion'],
            ['code' => 'billing.provider.update', 'name' => 'Actualizar proveedor de facturacion'],
            ['code' => 'billing.provider.manage', 'name' => 'Configurar proveedor de facturacion'],
            ['code' => 'security.context.read', 'name' => 'Consultar contexto autenticado y diagnosticos basicos'],
            ['code' => 'security.docs.read', 'name' => 'Consultar portal interno de documentacion'],
            ['code' => 'security.api-token.manage', 'name' => 'Gestionar tokens API del tenant'],
            ['code' => 'team.user.read', 'name' => 'Consultar equipo del tenant'],
            ['code' => 'team.user.manage', 'name' => 'Gestionar equipo del tenant'],
            ['code' => 'team.invitation.read', 'name' => 'Consultar invitaciones del tenant'],
            ['code' => 'team.invitation.manage', 'name' => 'Gestionar invitaciones del tenant'],
            ...
            ['code' => 'reports.platform-observability.read', 'name' => 'Consultar observabilidad tecnica de plataforma'],
            ...
            ['code' => 'pricing.price-list.read', 'name' => 'Consultar listas de precios'],
            ['code' => 'pricing.price-list.manage', 'name' => 'Gestionar listas de precios'],
            ['code' => 'pricing.promotion.read', 'name' => 'Consultar promociones comerciales'],
            ['code' => 'pricing.promotion.manage', 'name' => 'Gestionar promociones comerciales'],
            ['code' => 'pricing.quote.create', 'name' => 'Generar cotizaciones comerciales'],
            ['code' => 'pricing.quote.read', 'name' => 'Consultar cotizaciones comerciales'],
            ['code' => 'pos.sale.price.override', 'name' => 'Sobrescribir precio de venta POS'],
        ...
        $matrix = [
            'ADMIN' => ['pos.sale.execute', 'pos.sale.read', 'pos.sale.approve', 'sales.customer.create', 'sales.customer.read', 'sales.customer.update', 'sales.receivable.read', 'sales.receivable.pay', 'sales.receivable.follow-up.create', 'inventory.product.create', 'inventory.product.read', 'inventory.lot.create', 'inventory.lot.read', 'billing.voucher.issue', 'billing.voucher.read', 'billing.credit-note.issue', 'billing.credit-note.read', 'billing.outbox.dispatch', 'billing.outbox.read', 'billing.provider.read', 'billing.provider.update', 'billing.provider.manage', 'security.context.read', 'security.docs.read', 'security.api-token.manage', 'team.user.read', 'team.user.manage', 'team.invitation.read', 'team.invitation.manage', 'cash.session.open', 'cash.session.close', 'cash.session.read', 'cash.movement.create', 'cash.movement.read', 'audit.timeline.read', 'reports.daily.read', 'reports.due-reminders.read', 'reports.promise-compliance.read', 'reports.inventory.read', 'reports.billing-operations.read', 'reports.billing-operations.manage', 'reports.finance-operations.read', 'reports.finance-operations.manage', 'reports.operations-control-tower.read', 'reports.operations-control-tower.manage', 'reports.platform-observability.read', 'reports.operations-escalations.read', 'reports.operations-escalations.manage', 'reports.receivable-risk.read', 'reports.sales-profitability.read', 'purchase.supplier.create', 'purchase.supplier.read', 'purchase.order.create', 'purchase.order.read', 'purchase.replenishment.read', 'purchase.payable.read', 'purchase.payable.pay', 'purchase.payable.follow-up.create', 'purchase.receipt.create', 'purchase.receipt.read', 'purchase.return.create', 'purchase.return.read', 'stock.move.create', 'stock.move.read', 'pricing.price-list.read', 'pricing.price-list.manage', 'pricing.promotion.read', 'pricing.promotion.manage', 'pricing.quote.create', 'pricing.quote.read', 'pos.sale.price.override', 'rbac.role.assign', 'rbac.permission.manage'],
            'CAJERO' => ['pos.sale.execute', 'pos.sale.read', 'sales.customer.create', 'sales.customer.read', 'sales.customer.update', 'sales.receivable.read', 'sales.receivable.pay', 'sales.receivable.follow-up.create', 'inventory.product.read', 'billing.voucher.issue', 'billing.voucher.read', 'security.context.read', 'cash.session.open', 'cash.session.close', 'cash.session.read', 'cash.movement.create', 'cash.movement.read', 'pricing.quote.create', 'pricing.quote.read'],
            'ALMACENERO' => ['inventory.product.create', 'inventory.product.read', 'inventory.lot.create', 'inventory.lot.read', 'reports.inventory.read', 'purchase.supplier.read', 'purchase.order.read', 'purchase.replenishment.read', 'purchase.payable.read', 'purchase.payable.follow-up.create', 'purchase.receipt.create', 'purchase.receipt.read', 'purchase.return.create', 'purchase.return.read', 'stock.move.create', 'stock.move.read', 'security.context.read'],
        ];
