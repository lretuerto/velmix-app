...
class CashSessionFlowTest extends TestCase
{
    ...
    public function test_can_read_current_cash_session_summary(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertJsonPath('data.credit_sales_total', 0)
            ->assertJsonPath('data.receivable_cash_total', 0)
    ...
    public function test_can_list_cash_session_history_for_current_tenant(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertJsonPath('data.0.credit_sales_total', 0)
            ->assertJsonPath('data.0.receivable_cash_total', 0)
