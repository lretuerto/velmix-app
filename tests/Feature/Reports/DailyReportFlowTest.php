...
class DailyReportFlowTest extends TestCase
{
    ...
    public function test_reads_daily_operational_summary_for_current_tenant(): void
    {
        ...
        $this->actingAs($admin)
            ...
            ->assertJsonPath('data.operations_escalations.open_count', 6)
            ->assertJsonPath('data.operations_escalations.critical_count', 4)
            ->assertJsonPath('data.operations_escalations.warning_count', 1)
            ->assertJsonPath('data.operations_escalations.workflow.open_count', 6)
            ->assertJsonPath('data.operations_escalations.by_domain.billing_count', 5)
            ->assertJsonPath('data.operations_escalations.by_domain.finance_count', 1)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.active_count', 6)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.acknowledged_count', 0)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.stale_acknowledged_count', 0)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.acknowledged_event_count', 0)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.resolved_event_count', 0)
            ->assertJsonPath('data.operations_escalations.workflow_metrics.avg_minutes_from_ack_to_resolve', null)
            ->assertJsonPath('data.operations_escalations.top_queue.0.queue_key', 'billing:billing.failed_backlog')
            ...
            ->assertJsonPath('data.finance_operations.receivables.exposure.count', 3)
            ->assertJsonPath('data.finance_operations.receivables.exposure.outstanding_total', 31)
            ->assertJsonPath('data.finance_operations.receivables.promise_compliance.broken_count', 2)
            ->assertJsonPath('data.finance_operations.receivables.promise_compliance.pending_count', 1)
            ->assertJsonPath('data.finance_operations.receivables.follow_up_health.recent_count', 3)
            ->assertJsonPath('data.finance_operations.payables.exposure.count', 3)
            ->assertJsonPath('data.finance_operations.payables.exposure.outstanding_total', 57)
            ->assertJsonPath('data.finance_operations.payables.promise_compliance.broken_count', 2)
            ->assertJsonPath('data.finance_operations.payables.promise_compliance.pending_count', 1)
            ->assertJsonPath('data.finance_operations.combined.outstanding_total', 88)
            ->assertJsonPath('data.finance_operations.combined.overdue_total', 35)
            ->assertJsonPath('data.finance_operations.combined.broken_promise_count', 4)
            ->assertJsonPath('data.finance_operations.workflow.open_count', 6)
            ->assertJsonPath('data.finance_operations.workflow.acknowledged_count', 0)
            ->assertJsonPath('data.finance_operations.workflow.resolved_count', 0)
            ->assertJsonPath('data.finance_operations.workflow_metrics.active_count', 6)
            ->assertJsonPath('data.finance_operations.workflow_metrics.acknowledged_count', 0)
            ->assertJsonPath('data.finance_operations.workflow_metrics.stale_acknowledged_count', 0)
            ->assertJsonPath('data.finance_operations.workflow_metrics.avg_minutes_from_ack_to_resolve', null)
            ->assertJsonPath('data.finance_operations.priority_queue.0.reference', 'PUR-DAILY-OVERDUE')
