...
use App\Services\Reports\FinanceEscalationStateService;
...
Route::middleware(['auth.hybrid', 'tenant.context', 'tenant.access'])->group(function () {
    ...
    Route::get('/reports/finance-escalations/history', function (FinanceEscalationHistoryService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
            'history_days' => ['nullable', 'integer', 'min:1', 'max:90'],
    ...
    Route::get('/reports/finance-escalation-metrics', function (FinanceEscalationMetricsService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
            'history_days' => ['nullable', 'integer', 'min:1', 'max:90'],
    ...
    Route::get('/reports/finance-escalations/{code}', function (string $code, FinanceEscalationHistoryService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
            'history_days' => ['nullable', 'integer', 'min:1', 'max:90'],
    ...
    Route::post('/reports/finance-escalations/{code}/acknowledge', function (
        string $code,
        FinanceEscalationStateService $states,
        FinanceEscalationHistoryService $history
    ) {
        $payload = request()->validate([
            'note' => ['nullable', 'string', 'max:1000'],
            'date' => ['nullable', 'date_format:Y-m-d'],
    ...
    Route::post('/reports/finance-escalations/{code}/resolve', function (
        string $code,
        FinanceEscalationStateService $states,
        FinanceEscalationHistoryService $history
    ) {
    ...
    Route::get('/reports/operations-escalations', function (OperationsEscalationReportService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'billing_days' => ['nullable', 'integer', 'min:1', 'max:14'],
            'finance_days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
        ...
        return response()->json(['data' => $result]);
    })->middleware('perm:reports.operations-escalations.read');

    Route::get('/reports/operations-escalations/history', function (OperationsEscalationHistoryService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'billing_days' => ['nullable', 'integer', 'min:1', 'max:14'],
            'finance_days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
    ...
    Route::get('/reports/operations-escalation-metrics', function (OperationsEscalationMetricsService $service) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'billing_days' => ['nullable', 'integer', 'min:1', 'max:14'],
            'finance_days_ahead' => ['nullable', 'integer', 'min:1', 'max:30'],
    ...
    Route::get('/reports/operations-escalations/{domain}/{code}', function (
        string $domain,
        string $code,
        OperationsEscalationReportService $service
    ) {
        $payload = request()->validate([
            'date' => ['nullable', 'date_format:Y-m-d'],
            'billing_days' => ['nullable', 'integer', 'min:1', 'max:14'],
    ...
    Route::post('/reports/operations-escalations/{domain}/{code}/acknowledge', function (
        string $domain,
        string $code,
        OperationsEscalationReportService $service
    ) {
        ...
        return response()->json(['data' => $result]);
    })->middleware('perm:reports.operations-escalations.manage');

    Route::post('/reports/operations-escalations/{domain}/{code}/resolve', function (
        string $domain,
        string $code,
        OperationsEscalationReportService $service
    ) {
